...
// #endif
          ...
          case NR_SRS_ResourceSet__usage_codebook: {
            ...
            channel_matrix_list->n_matrix = nr_srs_channel_iq_matrix.num_ue_srs_ports * nr_srs_channel_iq_matrix.num_gnb_antenna_elements;
  ...
  nrmatrix__nr__srs__pack__pack(channel_matrix_list,buffer);
